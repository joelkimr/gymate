      ...
      <section className='hero-section xl:w-full lg:w-[110%] h-screen md:w-[150%] md:min-h-[52rem] min-h-[80rem] min-w-[60rem]'>
        <div className='container-hero'>
          <div
           ...
           absolute md:-right-[7rem] lg:right-52 lg:top-64 md:top-[19rem] top-96 md:left-auto left-48  w-[48rem]
           '>
            <p className='text-white lg:text-sm md:text-xl text-[25px] uppercase font-medium relative z-10 lg:pl-9 md:pl-14 pl-36 mb-8 '>
              find your energy
            </p>
            <Image
              src={TitleBg}
              alt='text_bg'
              className=' w-[54%] absolute -top-3 title-white md:ml-auto ml-20'
            />
        ...
        <div
          ...
          absolute lg:top-2/4 md:top-2/3 xl:-right-9 lg:-right-44 items-center md:-right-[28rem] right-[40rem] '>
